...
CREATE TABLE tb_produto (
    ...
    CONSTRAINT ck_tb_produto_preco
        CHECK (preco_unit > 0)
);
...
CREATE TABLE tb_venda_item (
    ...
    CONSTRAINT ck_tb_item_qtd
        CHECK (quantidade > 0),

    CONSTRAINT ck_tb_item_valor_unit
        CHECK (valor_unit >= 0),

    CONSTRAINT ck_tb_item_desconto
